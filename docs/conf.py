...
# -*- coding: utf-8 -*-
#
# LazGUI documentation build configuration file, created by
...
target_file = os.path.join( up_one, 'lazgui','_version.py')
...
latex_documents = [
  (master_doc, 'LazGUI.tex', 'LazGUI Documentation',
...
man_pages = [
    (master_doc, 'projectabcxyz', 'LazGUI Documentation',
     [author], 1)
]
...
texinfo_documents = [
  (master_doc, 'LazGUI', 'LazGUI Documentation',
   author, 'LazGUI', 'One line description of project.',
   'Miscellaneous'),
]
